...
////////////////////////////////////////////////////////////////////////////////////////////////////
void GamepadTrigger::OnActiveOnFocusChanged(Noesis::DependencyObject* d,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void GamepadTrigger::OnFiredOnChanged(Noesis::DependencyObject* d,
    const Noesis::DependencyPropertyChangedEventArgs& e)
{
    GamepadTrigger* trigger = (GamepadTrigger*)d;
    trigger->UnregisterSource(*static_cast<const GamepadTriggerFiredOn*>(e.oldValue));
    trigger->RegisterSource();
}
