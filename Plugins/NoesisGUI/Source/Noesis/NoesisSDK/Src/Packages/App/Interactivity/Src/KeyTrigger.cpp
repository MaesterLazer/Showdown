...
////////////////////////////////////////////////////////////////////////////////////////////////////
void KeyTrigger::OnActiveOnFocusChanged(Noesis::DependencyObject* d,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void KeyTrigger::OnFiredOnChanged(Noesis::DependencyObject* d,
    const Noesis::DependencyPropertyChangedEventArgs& e)
{
    KeyTrigger* trigger = (KeyTrigger*)d;
    trigger->UnregisterSource(*static_cast<const KeyTriggerFiredOn*>(e.oldValue));
    trigger->RegisterSource();
}
