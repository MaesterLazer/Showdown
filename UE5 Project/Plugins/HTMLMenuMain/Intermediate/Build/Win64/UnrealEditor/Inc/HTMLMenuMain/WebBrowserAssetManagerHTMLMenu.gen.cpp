...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWebBrowserAssetManagerHTMLMenu_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n *\n */" },
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWebBrowserAssetManagerHTMLMenu_Statics::NewProp_DefaultMaterial_MetaData[] = {
		{ "ModuleRelativePath", "Public/WebBrowserAssetManagerHTMLMenu.h" },
	};
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UWebBrowserAssetManagerHTMLMenu_Statics::NewProp_DefaultMaterial = { "DefaultMaterial", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWebBrowserAssetManagerHTMLMenu, DefaultMaterial), Z_Construct_UClass_UMaterial_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UWebBrowserAssetManagerHTMLMenu_Statics::NewProp_DefaultMaterial_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWebBrowserAssetManagerHTMLMenu_Statics::NewProp_DefaultMaterial_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UWebBrowserAssetManagerHTMLMenu_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWebBrowserAssetManagerHTMLMenu_Statics::NewProp_DefaultMaterial,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UWebBrowserAssetManagerHTMLMenu_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UWebBrowserAssetManagerHTMLMenu()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UWebBrowserAssetManagerHTMLMenu_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UWebBrowserAssetManagerHTMLMenu, 2680973756);
