...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "HTML Menu")
		UHTMLMenu* generateHTML_File(FString localSourceHTML_File, FString relativeTargetHTML_Directory, bool overwriteExistingFile, bool onlyInEditor=true);
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "HTML Menu")
		static void getSystemType(EHtmlMenuSystem& system);
